...
class TestAutogradingBaseUrl(unittest.TestCase):
    ...
    @patch('requests.post')
    def test_custom_url(self, mock_post, mock_get_username, mock_get_token, mock_check_internet):
    ...
    @patch('central_setup.central_setup.check_internet_connection', return_value=False)
    @patch('requests.post')
    def test_empty_url_uses_default(self, mock_post, mock_get_username, mock_get_token, mock_check_internet):
    ...
    @patch('central_setup.central_setup.check_internet_connection', return_value=False)
    @patch('requests.post')
    def test_no_env_var_uses_default(self, mock_post, mock_get_username, mock_get_token, mock_check_internet):
